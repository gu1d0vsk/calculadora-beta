...
FERIADOS = {
    ...
    datetime.date(2025, 1, 20): "São Sebastião (RJ)",
    ...
    datetime.date(2025, 4, 23): "São Jorge (RJ)",
    ...
    datetime.date(2026, 1, 20): "São Sebastião (RJ)",
    ...
    datetime.date(2026, 4, 23): "São Jorge (RJ)",
